ExternalProject_Add(mpv
    ...
    # Notes: run via plain `sh -c` (not ${EXEC}, which strips quotes), and never use
    # `;` here - CMake treats it as a list separator and splits the command.
    PATCH_COMMAND sh -c "git am --abort 2>/dev/null || true && git fetch origin tag v0.39.0 --no-tags 2>/dev/null || true && git reset --hard v0.39.0 && git clean -fd"
...
# mpv v0.39.0 keeps its public headers in libmpv/ (include/mpv/ is only used by newer mpv).
